...
#### 1.2.5. 실재로 var, let, const 중에 선택합니다.
...
### 1.4. 기본 데이터 종류 종류 (원시데이터 : Primitive Data Type )
...
- symbol : 지주가 망해도 절대로 겹치지 않는 변수이다.
...
### 1.5. 참조형 데이터 종류(Reference Date Type)
